...
from panda3d.pandac.Modules import Point2,Point3,Vec3,Vec4
...
from panda3d.direct.interval.FunctionInterval import Wait,Func
import cPickle, sys
...
def loadObject(tex = None, pos = Point2(0,0), depth = SPRITE_POS, scale = 1,
               transparency = True):
  obj = loader.loadModel("models/samples/asteroids/plane")
  ...
  if tex:
    tex = loader.loadTexture("models/samples/asteroids/"+tex+".png")
                                                     #Load the texture
