...
class World(DirectObject):
  def __init__(self):
    ...
    self.title = OnscreenText(text="Panda3D: Tutorial - Musicbox(sounds)", font=font,
                              style=1, fg=(1,1,1,1), pos=(0.7,-0.95), scale = .07)
    self.escapeEventText = OnscreenText(text="ESC: Quit", font = font,
    ...
    self.sliderText = OnscreenText("Volume", font = font,
