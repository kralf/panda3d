...
from panda3d.pandac.Modules import ParticleSystem
from panda3d.pandac.Modules import BaseParticleFactory
from panda3d.pandac.Modules import PointParticleFactory
from panda3d.pandac.Modules import ZSpinParticleFactory
#from panda3d.pandac.Modules import OrientedParticleFactory
from panda3d.pandac.Modules import BaseParticleRenderer
from panda3d.pandac.Modules import PointParticleRenderer
from panda3d.pandac.Modules import LineParticleRenderer
from panda3d.pandac.Modules import GeomParticleRenderer
from panda3d.pandac.Modules import SparkleParticleRenderer
#from panda3d.pandac.Modules import SpriteParticleRenderer
from panda3d.pandac.Modules import BaseParticleEmitter
from panda3d.pandac.Modules import ArcEmitter
from panda3d.pandac.Modules import BoxEmitter
from panda3d.pandac.Modules import DiscEmitter
from panda3d.pandac.Modules import LineEmitter
from panda3d.pandac.Modules import PointEmitter
from panda3d.pandac.Modules import RectangleEmitter
from panda3d.pandac.Modules import RingEmitter
from panda3d.pandac.Modules import SphereSurfaceEmitter
from panda3d.pandac.Modules import SphereVolumeEmitter
from panda3d.pandac.Modules import TangentRingEmitter
