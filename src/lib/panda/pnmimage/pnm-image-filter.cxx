...
// We have a function, defined in pnm-image-filter-core.T, that will scale
...
// The function in pnm-image-filter-core.T uses macros to access the member
...
#include "pnm-image-filter-core.T"
#undef SETVAL
#undef GETVAL
#undef BSIZE
#undef ASIZE
