...
addSingleResult(btManifoldPoint &mp,
                const btCollisionObjectWrapper *obj0, int part_id0, int idx0,
                const btCollisionObjectWrapper *obj1, int part_id1, int idx1) {


  BulletContact contact;

  contact._mp = &mp;
  contact._obj0 = obj0->getCollisionObject();
  contact._obj1 = obj1->getCollisionObject();
