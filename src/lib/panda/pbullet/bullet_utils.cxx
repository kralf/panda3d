...
//  Description: 
////////////////////////////////////////////////////////////////////
btVector3 LVecBase3_to_btVector3(const LVecBase3f &v) {
...
//  Description: 
////////////////////////////////////////////////////////////////////
LVecBase3f btVector3_to_LVecBase3(const btVector3 &v) {

  return LVecBase3f((PN_stdfloat)v.getX(),
                   (PN_stdfloat)v.getY(),
                   (PN_stdfloat)v.getZ());
}
...
//  Description: 
////////////////////////////////////////////////////////////////////
LVector3f btVector3_to_LVector3(const btVector3 &v) {

  return LVector3f((PN_stdfloat)v.getX(),
                  (PN_stdfloat)v.getY(),
                  (PN_stdfloat)v.getZ());
}
...
//  Description: 
////////////////////////////////////////////////////////////////////
LPoint3f btVector3_to_LPoint3(const btVector3 &p) {

  return LPoint3f((PN_stdfloat)p.getX(),
                 (PN_stdfloat)p.getY(),
                 (PN_stdfloat)p.getZ());
}
...
//  Description: 
////////////////////////////////////////////////////////////////////
btMatrix3x3 LMatrix3_to_btMatrix3x3(const LMatrix3f &m) {
...
//  Description: 
////////////////////////////////////////////////////////////////////
LMatrix3f btMatrix3x3_to_LMatrix3(const btMatrix3x3 &m) {

  btScalar cells[9];
  m.getOpenGLSubMatrix(cells);
  return LMatrix3f((PN_stdfloat)cells[0], (PN_stdfloat)cells[1], (PN_stdfloat)cells[2],
...
//  Description: 
////////////////////////////////////////////////////////////////////
btQuaternion LQuaternion_to_btQuat(const LQuaternionf &q) {
...
//  Description: 
////////////////////////////////////////////////////////////////////
LQuaternionf btQuat_to_LQuaternion(const btQuaternion &q) {

  return LQuaternionf((PN_stdfloat)q.getW(),
                     (PN_stdfloat)q.getX(),
                     (PN_stdfloat)q.getY(),
                     (PN_stdfloat)q.getZ());
}
...
//  Description: 
////////////////////////////////////////////////////////////////////
btTransform LMatrix4_to_btTrans(const LMatrix4f &m) {
...
//  Description: 
////////////////////////////////////////////////////////////////////
LMatrix4f btTrans_to_LMatrix4(const btTransform &trans) {
...
CPT(TransformState) btTrans_to_TransformState(const btTransform &trans, const LVecBase3f &scale) {
  ...
  LVecBase3f pos = btVector3_to_LVector3(trans.getOrigin());
  LQuaternionf quat = btQuat_to_LQuaternion(trans.getRotation());
