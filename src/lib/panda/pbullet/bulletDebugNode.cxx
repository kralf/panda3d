...
sync_b2p(btDynamicsWorld *world) {
  ...
  // Render lines
  {
    ...
    for (lit = _drawer._lines.begin(); lit != _drawer._lines.end(); lit++) {
      ...
      cwriter.add_data4f(LVecBase4f(line._color));
      cwriter.add_data4f(LVecBase4f(line._color));
  ...
  // Render triangles
  {
    ...
    for (tit = _drawer._triangles.begin(); tit != _drawer._triangles.end(); tit++) {
      ...
      cwriter.add_data4f(LVecBase4f(tri._color));
      cwriter.add_data4f(LVecBase4f(tri._color));
      cwriter.add_data4f(LVecBase4f(tri._color));
...
drawLine(const btVector3 &from, const btVector3 &to, const btVector3 &color) {
  ...
  line._p0 = LVecBase3f((PN_stdfloat)from.getX(),
                       (PN_stdfloat)from.getY(),
                       (PN_stdfloat)from.getZ());
  line._p1 = LVecBase3f((PN_stdfloat)to.getX(),
                       (PN_stdfloat)to.getY(),
                       (PN_stdfloat)to.getZ());
  line._color = Colorf((PN_stdfloat)r,
                      (PN_stdfloat)g, 
                      (PN_stdfloat)b, 1.0f);
...
drawTriangle(const btVector3 &v0, const btVector3 &v1, const btVector3 &v2, const btVector3 &color, btScalar) {
  ...
  tri._p0 = LVecBase3f((PN_stdfloat)v0.getX(),
                      (PN_stdfloat)v0.getY(),
                      (PN_stdfloat)v0.getZ());

  tri._p1 = LVecBase3f((PN_stdfloat)v1.getX(),
                      (PN_stdfloat)v1.getY(),
                      (PN_stdfloat)v1.getZ());

  tri._p2 = LVecBase3f((PN_stdfloat)v2.getX(),
                      (PN_stdfloat)v2.getY(),
                      (PN_stdfloat)v2.getZ());

  tri._color = Colorf((PN_stdfloat)r, 
                     (PN_stdfloat)g, 
                     (PN_stdfloat)b, 1.0f);
