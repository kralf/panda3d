...
GtkItemFactoryEntry GtkStatsMonitor::menu_entries[] = {
  { (char*)"/Options", NULL, NULL, 0, (char*)"<Branch>" },
  { (char*)"/Options/Units", NULL, NULL, 0, (char*)"<Branch>" },
  { (char*)"/Options/Units/ms", NULL, (vc *)&handle_menu_command, MI_time_ms,
    (char*)"<RadioItem>" },
  { (char*)"/Options/Units/Hz", NULL, (vc *)&handle_menu_command, MI_time_hz,
    (char*)"/Options/Units/ms" },
  { (char*)"/Speed", NULL, NULL, 0, (char*)"<Branch>" },
  { (char*)"/Speed/1", NULL, (vc *)&handle_menu_command, MI_speed_1,
    (char*)"<RadioItem>" },
  { (char*)"/Speed/2", NULL, (vc *)&handle_menu_command, MI_speed_2,
    (char*)"/Speed/1" },
  { (char*)"/Speed/3", NULL, (vc *)&handle_menu_command, MI_speed_3,
    (char*)"/Speed/1" },
  { (char*)"/Speed/6", NULL, (vc *)&handle_menu_command, MI_speed_6,
    (char*)"/Speed/1" },
  { (char*)"/Speed/12", NULL, (vc *)&handle_menu_command, MI_speed_12,
    (char*)"/Speed/1" },
  { (char*)"/Speed/sep", NULL, NULL, 0, (char*)"<Separator>" },
  { (char*)"/Speed/pause", NULL, (vc *)&handle_menu_command, MI_pause,
    (char*)"<CheckItem>" },
};
